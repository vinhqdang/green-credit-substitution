...
Table A1 reports, for all 47 economy-years in the paper's primary and extension samples, the SBFN
membership status coded for the analysis, the join year where applicable, the SBFN Multi-Tiered
Progress Framework stage in force nearest the survey year, and the exact year of the Worldwide
Governance Indicators observation used. Sourcing detail for every individual determination (the
specific SBFN Global Progress Report, country addendum, or accession announcement consulted) is
...
enough to that year to be reported with confidence, and is marked as such rather than estimated.
